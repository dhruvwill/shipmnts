...
const Tree = forwardRef<HTMLDivElement, TreeViewProps>(
  (
    ...
    return (
      ...
      >
        <div className={cn("size-full bg-secondary", className)}>
          <ScrollArea
            ref={ref}
      ...
      >
        ...
        >
          {expendedItems?.includes(value)
            ? openIcon ?? (
                <>
                  <FaAngleDown size={16} color="gray" />
                  <FaRegFolderOpen size={20} color="gray" />
                </>
              )
            : closeIcon ?? (
                <>
                  <FaAngleRight size={16} color="gray" />
                  <FaRegFolder size={20} color="gray" />
                </>
              )}
          <span>{element}</span>
        </AccordionPrimitive.Trigger>
    ...
    return (
      <AccordionPrimitive.Item value={value} className="relative">
        <AccordionPrimitive.Trigger
          ...
          aria-label="File"
          className={cn(
            "flex items-center gap-1 cursor-pointer text-md pr-1 rtl:pl-1 rtl:pr-0 rounded-md  duration-200 ease-in-out my-2",
            {
        ...
        >
          {fileIcon ?? <FaFile size={20} color="gray" />}
          {children}
        </AccordionPrimitive.Trigger>
      </AccordionPrimitive.Item>
    );
